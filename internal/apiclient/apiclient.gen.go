...
type ClientInterface interface {
	...
	DnssecDeleteRecordWithBody(ctx context.Context, domain DomainPath, keytag string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	DnssecDeleteRecord(ctx context.Context, domain DomainPath, keytag string, body DnssecDeleteRecordJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
type ClientWithResponsesInterface interface {
	...
	// DnssecDeleteRecordByKeyTagWithBodyWithResponse request with any body
	DnssecDeleteRecordByKeyTagWithBodyWithResponse(ctx context.Context, domain DomainPath, keytag string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*DnssecDeleteRecordResp, error)

	DnssecDeleteRecordByKeyTagWithResponse(ctx context.Context, domain DomainPath, keytag string, body DnssecDeleteRecordJSONRequestBody, reqEditors ...RequestEditorFn) (*DnssecDeleteRecordResp, error)
}
